...
export class TokenPolicyManager extends EStoreManagerBase {
  ...
  async getNamespaces(options: IEStoreManagerRequestOptions = {}): Promise<string[]> {
    ...
    , appendPathname('/admin/estore-with-token-policies')
    )
  ...
  , options: IEStoreManagerRequestOptions = {}
    ...
    const req = get(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/estore/${namespace}/token-policies`)
    )
  ...
  , options: IEStoreManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/estore/${namespace}/token-policies/write-token-required`)
    , json(val)
    )
  ...
  , options: IEStoreManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/estore/${namespace}/token-policies/read-token-required`)
    , json(val)
    )
  ...
  , options: IEStoreManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/estore/${namespace}/token-policies/delete-token-required`)
    , json(val)
    )
